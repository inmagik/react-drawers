...
| topCollapsedWidth    | bool   | The dimension of the top drawer when it is in the collapsed state    |
| leftCollapsedWidth   | bool   | The dimension of the left drawer when it is in the collapsed state   |
| rightCollapsedWidth  | bool   | The dimension of the right drawer when it is in the collapsed state  |
| bottomCollapsedWidth | bool   | The dimension of the bottom drawer when it is in the collapsed state |
